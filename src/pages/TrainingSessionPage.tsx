...
export function TrainingSessionPage() {
  ...
  return <div className="page session-page"><Link to="/train" className="back-link">退出本组</Link><SessionRunner quizzes={quizzes} onAnswer={(quiz, result) => recordAnswer(quiz.id, result.selectedOptionId, result.isRecommended)} onFinish={() => setDone(true)} /></div>;
}
