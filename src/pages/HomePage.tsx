...
export function HomePage() {
  return <div className="page home-page">
    <section className="home-intro"><div><span className="eyebrow">GUANDANLAB / 掼蛋实验室</span><h1>从看懂规则，到做出有理由的选择。</h1><p>两条学习路径，10 节短课，36 道可解释训练。进度只保存在你的浏览器。</p></div><div className="suit-board" aria-label="扑克牌花色装饰"><span className="black">♠</span><span className="red">♥</span><span className="red">♦</span><span className="black">♣</span></div></section>
